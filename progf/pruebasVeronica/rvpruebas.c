...
void  imprimirArreglo1D(  char *A, unsigned int tamanio, unsigned int tamanioSegmento);
...
int main () {
	...
	int n_P,ii,jj;
        ...
        //imprimirArreglo1D( Dat, 100, Bl_Size_byte );
	...
	//imprimirArreglo1D( ShufDat, 100, Bl_Size_byte );
        //printf("no lo se");
        //imprimirArreglo1D( Pack_temp, 100, Bl_Size_byte );
