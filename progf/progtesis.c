...
return 0;
    ...
    /*Este es el paso de shuffling.
      ...
      */
      ...
      ///////////Va el ciclo FOR.
	    R= rand();
	    T= R % M;
	    intercambiarArreglo(A, T, M, tamanio);
	    M--;
      ///////////Fin del ciclo FOR.
      /*Supongamos que L = 5, entonces M decrece de 5 a 2.*/
   ...
   /*=================================================================*/
   void intercambiaArreglo(unsigned int * A, unsigned int T, unsigned int M, unsigned int tamanio){
