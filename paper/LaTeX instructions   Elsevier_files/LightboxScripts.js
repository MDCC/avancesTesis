...
(function (e) {
    ...
    e.fn.ajaxSubmit = function (r) {
        ...
        var g = e('input[type=file]:enabled[value!=""]', this);
        var y = g.length > 0;
        var b = "multipart/form-data";
        var w = a.attr("enctype") == b || a.attr("encoding") == b;
        var E = t.fileapi && t.formdata;
        s("fileAPI :" + E);
        var S = (y || w) && !E;
        var x;
        if (r.iframe !== false && (r.iframe || S)) {
            if (r.closeKeepAlive) {
...
function lbgo(e,n) {
    if (e.indexOf("?") > -1) {
        var t = "&SQ_DESIGN_NAME=blank"
    } else {
        var t = "?SQ_DESIGN_NAME=blank"
    } if (e.indexOf("SQ_LAYOUT_NAME") < 0) t += "&SQ_LAYOUT_NAME=blank";
    $("html, body").animate({
            scrollTop: 0
        }, 300);
    $(".lb-inner").load(e + t, function () {
...
function lbchange(e) {
    $(".lb-inner").slideUp(300, function () {
        $(".lb-inner").html(e).slideDown(300);
        bindForms()
    })
}

function bindForms() {
    $(".lb-content form").ajaxForm({
            success: function (e) {
                lbchange(e)
            }
        })
...
$('a[data-lb="true"]').each(function (e, t) {
