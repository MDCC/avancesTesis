 ...
 * Renyi Map para enteros. q va de 1 a 101. Ademas, comenzamos con una semilla
 * que es un numero primo de mersene: 2147483647.
 */
...
unsigned long calcular_parametro(unsigned long q, unsigned int n, unsigned int i){
    ...
    printf("Calculo del parametro \n");
    printf("EL valor de q es: %lu",q);
    printf("EL valor de n es: %u",n);
    printf("EL valor de i es: %u",i);
